      ...
      {open && (
        ...
        >
          <button
            ...
            className="flex w-full items-center gap-2 rounded-lg px-2.5 py-1.5 text-[12px] font-semibold text-slate-700 hover:bg-slate-100 dark:text-slate-200 dark:hover:bg-slate-800"
          >
          ...
          <button
            ...
            className="flex w-full items-center gap-2 rounded-lg px-2.5 py-1.5 text-[12px] font-semibold text-red-600 hover:bg-red-50 dark:hover:bg-red-950/60"
          >
